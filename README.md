# Szonszczyk - Amonya - Ammo Loving Pony

Better description, download count and comments can be found on: [SPT Forge Link](https://forge.sp-tarkov.com/mod/2419/amonya-ammo-loving-trader-quester)

Server mod for Single Player Tarkov that is adding Amonya - trader and quest giver and in addition, ammo variants!
...
- "Mag of Holding" items - a magazine designed for storing massive amounts of ammo, but cannot be used in weapons. 3 tiers available. Can be obtained by exchanging special bullets earned through quests
- Native compatibility with various mods
- Automatic compatibility with known calibers added by mods
- Compatible with almost all modded weapons
